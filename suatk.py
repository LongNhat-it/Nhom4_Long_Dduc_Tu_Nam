...
class SuaTKPage:
    ...
    def view(self):
        ...
        save_btn = QLCafePage(button_frame, text="Lưu thay đổi", command=self.save_changes, style_type="success")
        save_btn.pack(side="left", padx=10)

        cancel_btn = QLCafePage(button_frame, text="Hủy bỏ", command=self.cancel, style_type="secondary")
        cancel_btn.pack(side="left", padx=10)

        reset_btn = QLCafePage(button_frame, text="Khôi phục", command=self.reset_form, style_type="warning")
